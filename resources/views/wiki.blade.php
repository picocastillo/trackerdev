...
@section('content')
    <div class="page-shell">
        @include('includes.page-header', [
            'title' => 'Wiki',
            'subtitle' => 'Guías de setup, checking y primeros pasos',
            'breadcrumbs' => [
        ...
        <div id="wiki" class="space-y-4">
            <div class="alert-warning">
                ...
                <p>Estos son algunos enlaces útiles
                    <a href="https://laravel.com/docs/7.x/installation">#Laravel</a>,
            ...
            <section class="card">
                <div class="card-header">Setup LAMP / Laravel</div>
                <div class="card-body font-mono text-sm leading-relaxed text-stone-700">
                    <div class="wiki">
                        <i>*** LAMP</i><br>
        ...
        <div id="checking" class="space-y-4">
            <div class="alert-warning">
                <h4 class="mb-2 font-semibold">Importante</h4>
            ...
            <section class="card">
                <div class="card-header">Checking de Testing</div>
                <div class="card-body">
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                        <div class="rounded-lg border border-stone-200 bg-stone-50/60 p-4 lg:col-span-8">
                            <h2 class="mb-3 text-lg font-semibold">Checklist</h2>
                            <ul class="list-disc space-y-1 pl-5 text-sm text-stone-700">
                                ...
                                <li>Las funcionalidades pedidas, ¿funcionan correctamente y estan completas?¿hay tratamiento de errores?</li>
                        ...
                        <div class="rounded-lg border border-stone-200 bg-stone-50/60 p-4 lg:col-span-4">
        ...
        <div id="get-started">
            <section class="card">
                ...
                <div class="card-body grid grid-cols-1 gap-6 lg:grid-cols-2">
                    ...
                    <div class="rounded-lg border border-stone-200 bg-stone-50/60 p-4 font-mono text-sm leading-relaxed text-stone-700">
                        <i>#LAMP</i><br>
                        <span>sudo apt update</span><br>
                        <span>sudo apt install apache2</span><br>
                        <span>sudo apt install mysql-server</span><br>
